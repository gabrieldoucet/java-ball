...
public class ScoreEditionGroup extends VBox {
  ...
  private ScoreEditionGroup() {
    ...
    labelScore1.setWrappingWidth(70);
    score1.setMaxWidth(30);
    score1.prefWidth(30);
    ...
    labelScore2.setWrappingWidth(70);
    score2.setMaxWidth(30);
    score2.prefWidth(30);
    ...
    updateButton.addEventHandler(MouseEvent.MOUSE_RELEASED, new EventHandler<MouseEvent>() {
      public void handle(MouseEvent e) {
        boolean score1Valid = Integer.parseInt(score1.getText()) >= 0 && Integer.parseInt(score1.getText()) <= 9;
        boolean score2Valid = Integer.parseInt(score2.getText()) >= 0 && Integer.parseInt(score2.getText()) <= 9;
        if (score1Valid && score2Valid) {
          // Update model
          MatchesList.updateMatchScore(labelScore1.getText(), score1.getText(), labelScore2.getText(),
              score2.getText());
    ...
    matchesComboBox.valueProperty().addListener((observable, oldValue, newValue) -> {
      updateButton.setDisable(disableUpdateButton(score1.getText(), score2.getText()));
      if (oldValue == null) {
    ...
    this.getChildren().addAll(matchesComboBox, team1Score, team2Score, updateButton);
  ...
  public boolean disableUpdateButton(String score1, String score2) {
    return matchesComboBox.getValue() == null || score1.equals("") || score2.equals("");
  }
}